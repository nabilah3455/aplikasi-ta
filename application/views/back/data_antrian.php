                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><a href="<?= base_url('pesanan/edit_status'); ?>?id_pesanan={id_pesanan}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                        ...
                                        <a href="<?= base_url('pesanan/pesanan_batal') ?>?id_pesanan={id_pesanan}" class="btn btn-danger" onclick="return confirm('Batalkan Pesanan {nama_konsumen} dengan jenis barang {nama_barang}, {jml_barang} barang?')">Batalkan Pesanan</a>
                                    </td>
                                </tr>
                                {/items}
                            </tbody>
